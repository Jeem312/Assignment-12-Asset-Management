			...
			<section className="py-20 dark:bg-gray-100 dark:text-gray-800">
				<div className="container px-4 mx-auto">
					...
					<div className="flex flex-wrap items-stretch -mx-4">
						...
						<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 ">
							<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-600 dark:text-gray-50 bg-green-400 text-white">
								<div className="space-y-2">
								...
								<p className="leading-relaxed">For Maximum 10 employees</p>
						...
						<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 ">
							<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50 bg-green-400 text-white">
								<div className="space-y-2">
									...
									<span className="text-6xl font-bold">$20

									</span>
								</div>
								<p className="leading-relaxed dark:text-gray-600">For Maximum 20 employees</p>
